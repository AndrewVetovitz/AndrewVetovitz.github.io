...
let InViewportDirective = class InViewportDirective {
     ...
     */
    constructor(el, win, cdRef, ngZone) {
        this.el = el;
        this.win = win;
        this.cdRef = cdRef;
        this.ngZone = ngZone;
    ...
    ngAfterViewInit() {
        ...
        this.ngZone.runOutsideAngular(() => {
            Observable$1.merge(fromEvent$1(this.win, eventWindowResize), fromEvent$1(this.win, eventWindowScroll))
                .auditTime(this.debounce)
                .subscribe(() => this.onViewportChange());
        });
        if (this.parent) {
            this.ngZone.runOutsideAngular(() => {
                fromEvent$1(this.parent, eventScroll)
                    .auditTime(this.debounce)
